package vn.soft.dc.recordengine.audio.calculators;
...
public class AudioCalculator {
    ...
    public double getFrequency(int sampleSize) {
        if (frequency == 0.0D) frequency = retrieveFrequency(sampleSize);
        return frequency;
    }

    private double retrieveFrequency(int sampleSize) {
